...
class NmtModel(object):
  ...
  def build(self):
    ...
    encoder_outputs, encoder_state_h, encoder_state_c = LSTM(units=self.hidden_size,
                                                             return_sequences=True,
                                                             return_state=True)(source_dropout)
  ...
  def eval(self, dataset):
    ...
    for i in range(5):
      print(i, 'TRANSLATED:', candidates[i])
      print(i, 'REFERENCE:', references[i])
